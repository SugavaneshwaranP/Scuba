              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <img
                    ...
                    height={500}
                    draggable={false}
                    className="h-full w-full rounded-3xl object-cover object-center shadow-2xl shadow-black/10"
                  />
                </motion.div>
              ))}
            </AnimatePresence>
          ...
          >
            ...
            {testimonials[active].features && (
              <div className="grid grid-cols-2 gap-4 mt-8">
                {testimonials[active].features.map((f, i) => (
                  <div key={i} className="flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-[#76A00E]" />
                    <span className="text-[10px] uppercase tracking-widest font-black opacity-40">{f}</span>
                  </div>
                ))}
              </div>
            )}
