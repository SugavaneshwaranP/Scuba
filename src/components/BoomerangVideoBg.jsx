...
/**
 * BoomerangVideoBg
 * Captures video frames then plays them forward → backward → forward in a loop.
 * Max capture width: 960px. Playback: 30fps on canvas.
 */
export default function BoomerangVideoBg({ src, className }) {
  ...
  /* ── Phase 2: boomerang playback on canvas ─────────── */
  useEffect(() => {
